...
if __name__ == "__main__":
    ...
    def save_to_excel():
        ...
        try:
            ...
            workbook = Workbook()
            sheet = workbook.active
            headers = ["ΗΜΕΡΟΜΗΝΙΑ", " EXTRA ", " ΤΙΜΗ ", " Α ", " ΤΙΜΗ ", " Β ", " ΤΙΜΗ ", " Γ ", " ΤΙΜΗ ",
                       " ΣΚΙΣΜΕΝΑ ", " ΤΙΜΗ "]
    ...
    def submit():
        ...
        c.execute(
            "INSERT INTO products VALUES (:date, :extra_size_kilos, :extra_size_price, :a_size_kilos, :a_size_price, :b_size_kilos, :b_size_price, :c_size_kilos, :c_size_price, :torn_kilos, :torn_price)",
            {
                "date": date.get(),
    ...
    def show():
        ...
        delete_button = Button(show, text="Διαγραφή όλων των Αρχείων", command=delete_all_data,
                               font=("arial black", 11),
                               background="#EA6969")
    ...
    def edit():
        ...
        date_editor = Label(editor, text="Ημερομηνία", font=("arial black", 16), background="#EEE8D1",
                            foreground="#5D046B")
    ...
    def open_kilos_w():
        ...
        total_extra_size_kilos_btn = Button(kilos_w, text="ΣΥΝΟΛΙΚΑ ΚΙΛΑ 'EXTRA'", command=total_extra_size_kilos,
                                            font=("arial black", 11), bd=4, background="#DE9C30",
                                            activeforeground="#DE9C30", activebackground="#DE9C30")
        ...
        total_a_size_kilos_btn = Button(kilos_w, text="ΣΥΝΟΛΙΚΑ ΚΙΛΑ 'Α'", command=total_a_size_kilos,
                                        font=("arial black", 11), bd=4, background="#DE9C30",
                                        activeforeground="#DE9C30", activebackground="#DE9C30")
        ...
        total_b_size_kilos_btn = Button(kilos_w, text="ΣΥΝΟΛΙΚΑ ΚΙΛΑ 'Β'", command=total_b_size_kilos,
                                        font=("arial black", 11), bd=4, background="#DE9C30",
                                        activeforeground="#DE9C30", activebackground="#DE9C30")
        ...
        total_c_size_kilos_btn = Button(kilos_w, text="ΣΥΝΟΛΙΚΑ ΚΙΛΑ 'Γ'", command=total_c_size_kilos,
                                        font=("arial black", 11), bd=4, background="#DE9C30",
                                        activeforeground="#DE9C30", activebackground="#DE9C30")
        ...
        total_torn_kilos_btn = Button(kilos_w, text="ΣΥΝΟΛΙΚΑ ΚΙΛΑ 'ΣΚΙΣΜΕΝΑ'", command=total_torn_kilos,
                                      font=("arial black", 11), bd=4, background="#DE9C30", activeforeground="#DE9C30",
                                      activebackground="#DE9C30")
        ...
        total_all_kilos_btn = Button(kilos_w, text="ΣΥΝΟΛΟ ΚΙΛΩΝ", command=total_all_kilos, font=("arial black", 13),
                                     bd=7, background="#1CC405", activeforeground="#1CC405", activebackground="#1CC405")
    ...
    def average_price():
        ...
        total_extra_size_price_btn = Button(price_w, text="ΜΕΣΗ ΤΙΜΗ 'EXTRA'", command=total_extra_size_price,
                                            font=("arial black", 11), bd=4, background="#DE9C30",
                                            activeforeground="#DE9C30", activebackground="#DE9C30")
        ...
        total_a_size_price_btn = Button(price_w, text="ΜΕΣΗ ΤΙΜΗ 'Α'", command=total_a_size_price,
                                        font=("arial black", 11), bd=4, background="#DE9C30",
                                        activeforeground="#DE9C30", activebackground="#DE9C30")
        ...
        total_b_size_price_btn = Button(price_w, text="ΜΕΣΗ ΤΙΜΗ 'Β'", command=total_b_size_price,
                                        font=("arial black", 11), bd=4, background="#DE9C30",
                                        activeforeground="#DE9C30", activebackground="#DE9C30")
        ...
        total_c_size_price_btn = Button(price_w, text="ΜΕΣΗ ΤΙΜΗ 'Γ'", command=total_c_size_price,
                                        font=("arial black", 11), bd=4, background="#DE9C30",
                                        activeforeground="#DE9C30", activebackground="#DE9C30")
        ...
        total_torn_price_btn = Button(price_w, text="ΜΕΣΗ ΤΙΜΗ 'ΣΚΙΣΜΕΝΑ'", command=total_torn_price,
                                      font=("arial black", 11), bd=4, background="#DE9C30", activeforeground="#DE9C30",
                                      activebackground="#DE9C30")
        ...
        total_average_btn = Button(price_w, text="ΣΥΝΟΛΙΚΗ ΜΕΣΗ ΤΙΜΗ", command=total_average, font=("arial black", 13),
                                   bd=8, background="#1CC405", activeforeground="#1CC405", activebackground="#1CC405")
    ...
    def total_euros():
        ...
        total_extra_size_euros_btn = Button(euros_w, text="ΣΥΝΟΛΙΚΑ ΕΥΡΩ 'EXTRA'", command=total_extra_size_euros,
                                            font=("arial black", 11), bd=4, background="#DE9C30",
                                            activeforeground="#DE9C30", activebackground="#DE9C30")
        total_extra_size_euros_btn.grid(row=1, column=0, pady=(25, 5), padx=10, ipadx=32)
        total_extra_size_euros_label = Label(euros_w, text="    ", font=("arial black", 14), background="#A2D8F0",
                                             relief="ridge", borderwidth=5, foreground="#42047A", width=15)
        total_extra_size_euros_label.grid(row=1, column=1, ipadx=100, pady=(25, 5))
        total_a_size_euros_btn = Button(euros_w, text="ΣΥΝΟΛΙΚΑ ΕΥΡΩ 'Α'", command=total_a_size_euros,
                                        font=("arial black", 11), bd=4, background="#DE9C30",
                                        activeforeground="#DE9C30", activebackground="#DE9C30")
        total_a_size_euros_btn.grid(row=2, column=0, pady=5, padx=10, ipadx=54)
        total_a_size_euros_label = Label(euros_w, text="    ", font=("arial black", 14), background="#A2D8F0",
                                         relief="ridge", borderwidth=5, foreground="#42047A", width=15)
        total_a_size_euros_label.grid(row=2, column=1, ipadx=100, pady=5)
        total_b_size_euros_btn = Button(euros_w, text="ΣΥΝΟΛΙΚΑ ΕΥΡΩ 'Β'", command=total_b_size_euros,
                                        font=("arial black", 11), bd=4, background="#DE9C30",
                                        activeforeground="#DE9C30", activebackground="#DE9C30")
        total_b_size_euros_btn.grid(row=3, column=0, pady=5, padx=10, ipadx=54)
        total_b_size_euros_label = Label(euros_w, text="    ", font=("arial black", 14), background="#A2D8F0",
                                         relief="ridge", borderwidth=5, foreground="#42047A", width=15)
        total_b_size_euros_label.grid(row=3, column=1, ipadx=100, pady=5)
        total_c_size_euros_btn = Button(euros_w, text="ΣΥΝΟΛΙΚΑ ΕΥΡΩ 'Γ'", command=total_c_size_euros,
                                        font=("arial black", 11), bd=4, background="#DE9C30",
                                        activeforeground="#DE9C30", activebackground="#DE9C30")
        total_c_size_euros_btn.grid(row=4, column=0, pady=5, padx=10, ipadx=54)
        total_c_size_euros_label = Label(euros_w, text="    ", font=("arial black", 14), background="#A2D8F0",
                                         relief="ridge", borderwidth=5, foreground="#42047A", width=15)
        total_c_size_euros_label.grid(row=4, column=1, ipadx=100, pady=5)
        total_torn_euros_btn = Button(euros_w, text="ΣΥΝΟΛΙΚΑ ΕΥΡΩ 'ΣΚΙΣΜΕΝΑ'", command=total_torn_euros,
                                      font=("arial black", 11), bd=4, background="#DE9C30", activeforeground="#DE9C30",
                                      activebackground="#DE9C30")
        total_torn_euros_btn.grid(row=5, column=0, pady=5, padx=10, ipadx=15)
        total_torn_euros_label = Label(euros_w, text="    ", font=("arial black", 14), background="#A2D8F0",
                                       relief="ridge", borderwidth=5, foreground="#42047A", width=15)
        total_torn_euros_label.grid(row=5, column=1, ipadx=100, pady=5)
        total_all_euros_btn = Button(euros_w, text="ΣΥΝΟΛΟ ΕΥΡΩ ", command=total_all_euros, font=("arial black", 13),
                                     bd=8, background="#1CC405", activeforeground="#1CC405", activebackground="#1CC405")
    ...
    def total_profit():
        ...
        workers_label = Label(profit_window, text="ΚΟΣΤΟΣ ΕΡΓΑΤΩΝ :", font=("arial black", 12), background="#DE9C30",
                              relief="ridge", borderwidth=5, foreground="black", width=28)
        workers_label.grid(row=1, column=0, pady=(20, 0), sticky=W, padx=10)
        pesticide_label = Label(profit_window, text="ΦΥΤΟΦΑΡΜΑΚΑ & ΛΙΠΑΣΜΑΤΑ:", font=("arial black", 12),
                                background="#DE9C30", relief="ridge", borderwidth=5, foreground="black", width=28)
        pesticide_label.grid(row=2, column=0, sticky=W, padx=10)
        total_euros_label = Label(profit_window, text="ΣΥΝΟΛΙΚΑ ΕΥΡΩ :", font=("arial black", 12), background="#DE9C30",
                                  relief="ridge", borderwidth=5, foreground="black", width=28)
    ...
    date_label = Label(root, text="  ΗΜΕΡ/ΝΙΑ :  ", font=("arial black", 13), background="#EEE8D1", relief="ridge",
                       borderwidth=3, foreground="#03647A")
    date_label.grid(row=2, column=0, pady=(20, 0), sticky=W, padx=20)
    kilos_label = Label(root, text="ΚΙΛΑ", font=("arial black", 15), background="#8DDFE1", foreground="#8B0669",
                        relief="ridge", bd=5, width=5)
    kilos_label.grid(row=2, column=1, sticky=W, padx=40, pady=(10, 0))
    price_label = Label(root, text="ΤΙΜΗ", font=("arial black", 15), background="#8DDFE1", foreground="#8B0669",
                        relief="ridge", bd=5, width=5)
    price_label.grid(row=2, column=2, sticky=W, padx=40, pady=(10, 0))

    extra_size_kilos_label = Label(root, text="ΜΕΓΕΘΟΣ 'EXTRA' : ", font=("arial black", 12), foreground="#5D046B",
                                   background="#EEE8D1")
    extra_size_kilos_label.grid(row=3, column=0, sticky=W, padx=40, pady=7)
    a_size_kilos_label = Label(root, text="ΜΕΓΕΘΟΣ  'Α' : ", font=("arial black", 12), foreground="#5D046B",
                               background="#EEE8D1")
    a_size_kilos_label.grid(row=4, column=0, sticky=W, padx=40, pady=7)
    b_size_kilos_label = Label(root, text="ΜΕΓΕΘΟΣ  'Β' : ", font=("arial black", 12), foreground="#5D046B",
                               background="#EEE8D1")
    b_size_kilos_label.grid(row=5, column=0, sticky=W, padx=40, pady=7)
    c_size_kilos_label = Label(root, text="ΜΕΓΕΘΟΣ  'Γ' : ", font=("arial black", 12), foreground="#5D046B",
                               background="#EEE8D1")
    c_size_kilos_label.grid(row=6, column=0, sticky=W, padx=40, pady=7)
    torn_kilos_label = Label(root, text="'ΣΚΙΣΜΕΝΑ' :", font=("arial black", 12), foreground="#5D046B",
                             background="#EEE8D1")
    torn_kilos_label.grid(row=7, column=0, sticky=W, padx=40, pady=7)
    delete_box_label = Label(root, text="ΕΠΙΛΟΓΗ ID : ", font=("arial black", 13), relief="ridge", borderwidth=3,
                             foreground="#03647A", background="#EEE8D1")
    ...
    submit_btn = Button(root, text="Εισαγωγή Στοιχείων", command=submit, font=("arial black", 12), bd=4,
    ...
    show_btn = Button(root, text="Εμφάνιση Στοιχείων", command=show, font=("arial black", 12), bd=4,
    ...
    delete_btn = Button(root, text="Διαγραφή Στοιχείων", command=delete, font=("arial black", 12), bd=4,
    ...
    edit_btn = Button(root, text="Επεξεργασία Στοιχείων", command=edit, font=("arial black", 12), bd=4,
    ...
    total_kilos_btn = Button(root, text="ΣΥΝΟΛΙΚΑ ΚΙΛΑ", command=open_kilos_w, width=23, font=("arial black", 12), bd=7,
                             background="#8CD0EC", activebackground="#A481C9", activeforeground="#A481C9")
    total_kilos_btn.grid(row=11, column=0, pady=(20, 10))

    total_euros_btn = Button(root, text="ΣΥΝΟΛΙΚΑ ΕΥΡΩ", command=total_euros, width=23, font=("arial black", 12), bd=7,
                             background="#8CD0EC", activebackground="#A481C9", activeforeground="#A481C9")
    total_euros_btn.grid(row=11, column=1, columnspan=2, pady=(20, 10))

    average_price_btn = Button(root, text="ΜΕΣΗ ΤΙΜΗ", command=average_price, width=23, font=("arial black", 12), bd=7,
                               background="#8CD0EC", activebackground="#A481C9", activeforeground="#A481C9")
    average_price_btn.grid(row=12, column=0, pady=(5, 10))

    total_profit_btn = Button(root, text="ΣΥΝΟΛΙΚΟ ΚΕΡΔΟΣ", command=total_profit, width=23, font=("arial black", 12),
                              bd=7, background="#8CD0EC", activebackground="#A481C9", activeforeground="#A481C9")
    total_profit_btn.grid(row=12, column=1, columnspan=2, pady=(5, 5))

    name_label = Label(root, text="Created and Designed by : Papaioannou Antonios", font=("arial black", 10),
                       foreground="grey", background="#EEE8D1", borderwidth=1)
