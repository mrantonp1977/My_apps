...
if __name__ == "__main__":
    ...
    def open_total():
        ...
        def total_profit():
            ...
            workers_label = Label(profit_window, text="ΚΟΣΤΟΣ ΕΡΓΑΤΩΝ :", font=("arial black", 12),
                                  foreground="#721E8D",
                                  background="#EEE8D1")
            ...
            total_profit1_label = Label(profit_window, text="ΣΥΝΟΛΙΚΟ ΚΕΡΔΟΣ  :  0 € ", font=("arial black", 14),
                                        width=30,
        ...
        calculate_euro_btn = Button(total_w, text="ΥΠΟΛΟΓΙΣΜΟΣ ΕΥΡΩ", command=calculate_total_euro,
                                    font=("arial black", 11),
        ...
        total_euro_label = Label(total_w, text="ΣΥΝΟΛΟ ΕΥΡΩ   :  0 €   ", font=("arial black", 13),
                                 background="#A2D8F0",
        ...
        total_kilo_m_label = Label(total_w, text="ΣΥΝΟΛΙΚΑ ΜΕΙΚΤΑ ΚΙΛΑ   :  0      ", font=("arial black", 13),
                                   width=25,
                                   background="#A2D8F0", relief="ridge", borderwidth=5, foreground="#42047A")
        ...
        total_kilo_k_label = Label(total_w, text="ΣΥΝΟΛΙΚΑ ΚΑΘΑΡΑ ΚΙΛΑ   :  0      ", font=("arial black", 13),
                                   width=25,
                                   background="#A2D8F0", relief="ridge", borderwidth=5, foreground="#42047A")
    ...
    def select_variety():
        ...
        if selected_variety:
            c.execute(
                "SELECT variety, SUM(items), SUM(kilo_m), SUM(kilo_k), SUM(kilo_k * price) AS total_euro FROM products WHERE variety=? GROUP BY variety",
                (selected_variety,))
            ...
            if variety_info:
                ...
                for row_index, variety_data in enumerate(variety_info):
                    for i, label in enumerate(info_labels):
                        label_text = Label(variety_window, text=label, font=("arial black", 12), width=15,
                                           relief="ridge", bd=3, background="#F1B52D")
                        label_text.grid(row=row_index * len(info_labels) + i, column=0, padx=30, sticky=W, pady=10)

                        if i == 4:
                            # Display the sum of prices
                            value_label = Label(variety_window, text=variety_data[i], font=("arial black", 13),
                                                width=15,
                                                background="#A2D8F0", relief="ridge", borderwidth=5,
                                                foreground="#42047A")
                        else:
    ...
    date_label = Label(root, text="  Ημερομηνία : ", font=("arial black", 13), background="#EEE8D1",
                       foreground="#5D046B")
    date_label.grid(row=1, column=0, pady=(20, 0), sticky=W, padx=80)
    variety_label = Label(root, text="  Ποικιλία : ", font=("arial black", 13), background="#EEE8D1",
                          foreground="#5D046B")
    ...
    kilo_m_label = Label(root, text="  Κιλά Μεικτά : ", font=("arial black", 13), background="#EEE8D1",
                         foreground="#5D046B")
    kilo_m_label.grid(row=4, column=0, sticky=W, padx=80)
    kilo_k_label = Label(root, text="  Κιλά Καθαρά : ", font=("arial black", 13), background="#EEE8D1",
                         foreground="#5D046B")
    ...
    delete_box_label = Label(root, text="  Επιλογή ID ", font=("arial black", 14), background="#EEE8D1",
                             foreground="#050EA3")
    ...
    total_btn = Button(root, text=" ΣΥΝΟΛΑ ", font=("arial black", 11), command=open_total, bd=6, background="#06D784",
                       activebackground="#06D784", activeforeground="#06D784")
    ...
    select_btn = Button(root, text="Επιλογή Ποικιλίας :", command=select_variety, font=("arial black", 11),
                        background="#0FAFC3")
