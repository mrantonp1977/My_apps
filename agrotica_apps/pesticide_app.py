...
if __name__ == "__main__":
    ...
    def open_total_balance():
        ...
        balance_btn = Button(balance_w, text=" ΣΥΝΟΛΙΚΟ ΥΠΟΛΟΙΠΟ ", font=("arial black", 11),
                             command=total_balance_euros, bd=6,
    ...
    def total_cash():
        ...
        def delete_all_data_cash():
            confirmation = messagebox.askyesno("Confirmation",
                                               "Είστε σίγουρος ότι θέλετε να διαγράψετε όλα τα Αρχεία ;")
            if confirmation:
                conn = sqlite3.connect("total_cash_file.db")
                c = conn.cursor()
        ...
        def edit_cash():
            ...
            date_given_editor_label = Label(editor_csh, text="    ΗΜΕΡ/ΝΙΑ :   ", font=("arial black", 14),
                                            relief="ridge", bd=5,
                                            background="#DC9127")
            date_given_editor_label.grid(row=1, column=0, sticky=W, padx=20, pady=(20, 10))
            euros_given_editor_label = Label(editor_csh, text="    ΜΕΤΡΗΤΑ :   ", font=("arial black", 14),
                                             relief="ridge", bd=5,
                                             background="#DC9127")
        ...
        date_given_label = Label(cash_w, text="    ΗΜΕΡ/ΝΙΑ :   ", font=("arial black", 12), relief="ridge", bd=5,
                                 background="#DC9127")
        date_given_label.grid(row=1, column=0, sticky=W, padx=20, pady=(20, 10))
        euros_given_label = Label(cash_w, text="    ΜΕΤΡΗΤΑ :   ", font=("arial black", 12), relief="ridge", bd=5,
                                  background="#DC9127")
        euros_given_label.grid(row=2, column=0, sticky=W, padx=20, pady=(20, 10))
        choose_csh_id_label = Label(cash_w, text="    ΕΠΙΛΟΓΗ ID :   ", font=("arial black", 12), relief="ridge", bd=5,
                                    background="#DC9127")
    ...
    cash_btn = Button(root, text=" ΜΕΤΡΗΤΑ € ", font=("arial black", 11), command=total_cash, bd=6,
                      background="#08CBCB", activebackground="#08CBCB", activeforeground="#08CBCB")
    cash_btn.grid(row=9, column=1, pady=(20, 5), ipadx=80)
    total_btn = Button(root, text=" ΣΥΝΟΛΟ € ", font=("arial black", 11), command=open_total_euros, bd=6,
                       background="#08CBCB", activebackground="#08CBCB", activeforeground="#08CBCB")
    total_btn.grid(row=9, column=0, pady=(20, 5), ipadx=80)

    total_balance_btn = Button(root, text="  ΥΠΟΛΟΙΠΟ €  ", font=("arial black", 11), command=open_total_balance, bd=6,
                               background="#08CBCB", activebackground="#08CBCB", activeforeground="#08CBCB")
    ...
    name_label = Label(root, text="Created and Designed by : Papaioannou Antonios", font=("arial black", 11),
                       foreground="grey", background="#CAE1DA", borderwidth=1)
